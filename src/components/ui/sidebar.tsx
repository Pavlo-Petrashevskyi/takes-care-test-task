  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            //changed h-svh to h-max to get rid of extra space which covered sidebar
            "duration-200 relative h-max w-[--sidebar-width] bg-transparent transition-[width] ease-linear",
